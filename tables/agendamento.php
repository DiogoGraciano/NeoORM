...
class agendamento extends model {
    ...
    public static function table(){
        return (new table(self::table,comment:"Tabela de agendamentos"))
                ...
                ->addColumn((new column("dt_ini","DATETIME"))->isNotNull()->setComment("Data inicial de agendamento"))
                ->addColumn((new column("dt_fim","DATETIME"))->isNotNull()->setComment("Data final de agendamento"))
